...
{\r\n
    ...
    {\r\n
        ...
        if (\$PSdebug) {Write-Host -NoNewLine "Session Opened, File Permision and timestamp not Reserved." };\r\n
...
def exitCode = ch.runCommand("Deploy script Start... SFTP Advance", cmdArgs)
